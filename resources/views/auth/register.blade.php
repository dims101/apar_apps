              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Masukan data pengguna untuk mendaftar</p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('register') }}" >
                    @csrf
                    <div class="col-12">
                      <label for="yourName" class="form-label @error('nama') is-invalid @enderror">Masukan Nama</label>
                    ...
                    <div class="col-12">
                      <label for="yourPenneng" class="form-label @error('penneng') is-invalid @enderror">Masukan No. Penneng</label>
                      <input type="text" name="penneng" class="form-control" id="yourPenneng" value="{{old('penneng')}}" required>
                      @error('penneng')
                      <div class="invalid-feedback">Masukan no. penneng yang valid!</div>
                      @enderror
                    </div>
                    ...
                    <div class="col-12">
                      <label for="yourPasswordConfirm" class="form-label @error('password') is-invalid @enderror">Konfirmasi Password</label>
